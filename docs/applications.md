...
| hister             | on     | Deployment, SQLite/index on iSCSI, hister.cluster.f4mily.net; SearXNG fallback |
...
When migrating an app from a legacy storage class to NFS, you must first delete the
